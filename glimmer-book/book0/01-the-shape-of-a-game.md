...
you and the metal, every byte where you put it. Assembly is not the
obstacle here. The obstacle is how much a game has to do at once. A game
is never only its rules. The keys have to be watched, the display kept
