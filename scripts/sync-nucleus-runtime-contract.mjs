...
syncSpecification({
  expectedSource: "docs/z80-runtime-contract.md",
  ...
  localLinks: new Map([
    ["specification.md", "../language/"],
    [
      "target-system-specification.md",
      "https://github.com/jhlagado/nucleus/blob/main/docs/target-system-specification.md",
    ],
    [
      "nucleus-object-format.md",
      "https://github.com/jhlagado/nucleus/blob/main/docs/nucleus-object-format.md",
    ],
  ]),
});
