...
This Debug80 book is being written now. The chapter pages are publishable stubs: they show the intended path through the TEC-1G, MON-3, Debug80 projects and targets, and the hardware features that make the machine worth programming.

Debug80 Book 1 introduced the Debug80 workflow. Book 2 makes the target machine concrete. It starts with the TEC-1G as a modern rebirth of a 1980s learning-computer idea, then uses MON-3 services and Debug80 before moving down to direct ports and timing-sensitive display work.
...
[← Debug80 Books](../index.md) | [Introduction →](00-introduction.md)
