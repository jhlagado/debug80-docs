...
Most Debug80 work is done from the Debug80 panel: project selection, target selection, building, CoolTerm testing and sending HEX files to hardware. Use the Command Palette for commands that are easier to reach from the keyboard or that open source-navigation tools.

Open the VS Code Command Palette with **Shift-Command-P** on macOS or **Shift-Control-P** on Windows and Linux.
