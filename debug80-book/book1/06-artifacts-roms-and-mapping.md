...
Copy assets when you want to inspect monitor source, compare a ROM or keep a project self-contained. You do not need local copies for ordinary debugging with a bundled profile.
