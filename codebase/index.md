...
- **Hardware send workflow:** Debug80 can hand a built HEX artifact to a real board through CoolTerm's Remote Control Socket. This lives in the extension host and is intentionally separate from the emulated serial terminal.
