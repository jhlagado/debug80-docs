...
This manual is updated against the codebase state through **2026-05-29**. These notes give maintainers a quick view of changes that affect several chapters:
...
- **Source map cache removal:** Debug80 no longer writes project-local `.debug80/cache` D8 maps. Active target maps resolve to build-side `<artifactBase>.d8.json`.
