...
Knowing which instruction last set a flag, and whether anything between that instruction and your branch changed it, is the part that catches people.
...
P/V is the flag that confuses people longest. If the dual meaning is unclear right now, that is fine — put it aside until you need it. Z and C will carry you through most of Book 2.
