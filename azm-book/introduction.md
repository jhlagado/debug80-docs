...
**The AZM Assembler Manual** is the supplementary route for experienced assembly programmers. It does not teach Z80 from first principles; it documents AZM syntax, directives, expressions, layout types, op declarations, diagnostics, and output formats directly.
