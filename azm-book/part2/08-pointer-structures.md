...
Part 2 does not use a heap allocator. You **name** nodes as labels and connect them at assembly time or in `main`:
...
`list_head` holds a word at a known label. Part 1 Chapter 4’s absolute word load applies:
